...
<body>
  ...
  <div>
    ...
    <input type="button" name="vipseat" value="S1" onclick="selectSeat(this)" />
    <input type="button" name="vipseat" value="S2" onclick="selectSeat(this)" />
    <input type="button" name="vipseat" value="S3" onclick="selectSeat(this)" />
    <input type="button" name="regularseat" value="S4" onclick="selectSeat(this)" />
    <input type="button" name="regularseat" value="S5" onclick="selectSeat(this)" />
    <input type="button" name="regularseat" value="S6" onclick="selectSeat(this)" />
    <input type="button" name="regularseat" value="S7" onclick="selectSeat(this)" />
    <input type="button" name="regularseat" value="S8" onclick="selectSeat(this)" />
    <input type="button" name="groupseat" value="S9" onclick="selectSeat(this)" />
    <input type="button" name="groupseat" value="S10" onclick="selectSeat(this)" />
  </div>
